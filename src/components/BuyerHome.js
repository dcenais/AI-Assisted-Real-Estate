...
import { Box, Typography, Grid, Paper, Button, CircularProgress, Container, TextField } from '@mui/material';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* WHY BUY WITH US - Single Container */}
        <Grid container spacing={2} sx={{ mb: 6 }} justifyContent="center">
          <Grid item xs={12}>
            <Paper sx={{ p: 4, borderRadius: 2, boxShadow: 2, backgroundColor: '#ffffff' }}>
              ...
              >
                Our platform offers an unparalleled property-buying experience. Here’s why buying through us is the best choice for you:
                <ul>
                  <li><strong>Verified Listings:</strong> Every property listed on our platform is thoroughly vetted for authenticity and legal compliance, giving you peace of mind in your investment decisions.</li>
                  ...
                  <li><strong>Personalized Support:</strong> Whether you're a first-time buyer or a seasoned investor, our team and AI chatbot are here to guide you at every stage of the buying process, ensuring a seamless journey from search to purchase.</li>
                </ul>
              </Typography>
            </Paper>
          </Grid>
