...
import {
  Container, Typography, TextField, Grid, Card, CardMedia, CardContent, Button
} from '@mui/material';
...
const Rent = () => {
  ...
  useEffect(() => {
    fetch('http://127.0.0.1:5000/api/rent-properties')
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 6 }}>
      ...
      <Typography variant="subtitle1" color="textSecondary" paragraph>
        Find your ideal rental space in the most convenient locations. Use the filters to find what suits you best.
      </Typography>
